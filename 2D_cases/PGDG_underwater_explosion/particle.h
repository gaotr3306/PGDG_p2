...
// variables
  ...
  Real    rho[2];  
  Real    rho0[2];  
  Vector<Real, 3> rhov[2];//
  Real    E[2];//2026.1.27
  Real    mu[2];//
  Real     c[2];
  Matrix<Real,UNum, BaseNum+1> coef0[2];//2025.12.25
  Matrix<Real,UNum, BaseNum+1 > coef[2];//2025.12.25
  Matrix<Real,UNum, BaseNum+1 > dcoef[2];//2025.12.26
  Vector<Real, UNum> Lim_u[2];//
  Vector<Real, 3> rhov_0;//
  Vector<Real, 3> coord_0;//
  Real    rho_0;  
  Real E_0 =0;//2026.1.27
  int ph_state[2] ;  //2026.1.16
  int ph_state_b[2] ; //2026.1.16
  Matrix<Real,DIM, DIM > G_v;//2026.1.23
  Real     alph[2];//2026.1.21
  Real ee=0;//2026.2.1
  Real vol_0 = 0;//2026.2.6

  Real aph_dt[2];
  Real alph0[2];//2026.2.9
  Real ca =0;//2026.2.9
  Real Ea =0;//2026.2.9
  Real rhoa =0;//2026.2.9
  Real gamma_a =0;//2026.2.9
  Real Pp_a =0;//2026.2.9
