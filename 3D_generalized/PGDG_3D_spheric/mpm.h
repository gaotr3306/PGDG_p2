...
public:
  ...
  concurrent_vector <int> bound; //20260618
...
public:
  ...
  Real ini_rho[FldNum];
  Real c[FldNum]; //2026.1.20
  Real mu[FldNum];
  Real gamma[FldNum];
  Real Pp0[FldNum]; //20260616
...
// functions
  ...
  void Reset_particle_neighbor_info(communicator &world,int flag); //2027.7.3
  ...
  void Update_grid(communicator &world, int md);//
  ...
  void Reset_refresh_merge_neighbor(communicator &world);//2026.2.7
  Vector<Real, 3> MGFM(Real ul, Real ur, Real pl, Real pr, Real rhol, Real rhor, int s, int s1);//20260611
